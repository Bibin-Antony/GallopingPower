...
import { ArrowLeft, ArrowRight, Calendar, MapPin, Timer, Award,ChevronLeft } from 'lucide-react';
...
const PreviousForm = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-200 via-purple-200 to-pink-200 py-12 px-4 sm:px-6 lg:px-8">
      ...
      <button
          onClick={() => navigate(-1)}
          className="mb-6 inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 bg-white/80 rounded-lg hover:bg-white/90 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 shadow-sm backdrop-blur-sm"
        >
