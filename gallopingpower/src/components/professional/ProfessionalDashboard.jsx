...
import { Activity, Calendar, Award, TrendingUp, LayoutDashboard, ChevronRight, Menu, X } from 'lucide-react';
...
const ProfessionalDashboard = () => {
  ...
  const cards = [
    ...
    },
    {
      ...
      icon: <Calendar />,
      variant: 'teal',
      path: "/professional/handicap"
    },
    {
      title: "Acceptance Card",
      icon: <Calendar />,
      variant: 'amber',
      path: "/professional/acceptance"
    },
    {
      title: "Race Card",
      icon: <Calendar />,
      variant: 'rose',
      path: "/professional/race"
    }
  ];

  const menuItems = [
    { name: 'Dashboard', icon: <LayoutDashboard size={20} />, path: '/professional' }
  ];

  const isMainDashboard = location.pathname === '/professional';
        ...
        <div className="p-4 sm:p-6 lg:p-8">
          <div className="mb-8">
            <div className="flex items-center justify-between bg-gray-100 p-4 sm:p-6 rounded-xl shadow-sm border border-gray-300">
              <div>
                <h1 className="text-xl sm:text-2xl font-bold text-gray-800">Professional Dashboard</h1>
                <p className="text-sm sm:text-base text-gray-600 mt-1">Welcome back, Professional</p>
              </div>
